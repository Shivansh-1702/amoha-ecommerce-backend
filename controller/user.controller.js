  ...
  try {
    ...
    if (user) {
      ...
      const mailData = {
        ...
        <p>Verify your email address to complete the signup and login into your <strong>amoha</strong> account.</p>
          ...
          <p style="margin-top: 35px;">If you did not initiate this request, please contact us immediately at support@amoha.com</p>
  
          <p style="margin-bottom:0px;">Thank you</p>
          <strong>amoha Team</strong>
           `,
      };
